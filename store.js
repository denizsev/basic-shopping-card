...
if (document.readyState == 'loading') { //Her Jvasciptinde bunu kullan!!!!!!
    document.addEventListener("DOMContentLoaded", ready)
} else {
    ready();
};

//eger javascript html den once yuklenmisse diye kontrol yaptik ready diye fonk ekeldik
...
function addItemToCart(title, price, imageSrc) {
  ...
  <div class="cart-item cart-column">
                        ...
                        <span class="cart-item-title">${title}t</span>
                    </div>
